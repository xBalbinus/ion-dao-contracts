...
// use cw20::{
//     Balance, BalanceResponse, Cw20Coin, Cw20CoinVerified, Cw20Contract, Cw20ExecuteMsg,
//     Cw20QueryMsg, Denom,
// };
// use cw3::{Status, Vote};
...
//             Balance::Cw20(cw20_balance) => {
//                 let msg = cw20::Cw20ExecuteMsg::Send {
//                     contract: staking_addr.to_string(),
//                     amount: cw20_balance.amount.checked_div(Uint128::new(2)).unwrap(),
...
//     );
//     assert!(res.is_err());
//     let res: Result<BalancesResponse, _> = app.wrap().query_wasm_smart(
//         &dao_addr,
...
//         limit: None,
//     };
//     let all_balances: BalancesResponse = app
//         .wrap()
